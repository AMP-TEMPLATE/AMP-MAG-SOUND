...
|Contain a <br /> `<meta name="viewport" content="width=device-width,minimum-scale=1">`tag inside their <head> tag. It's also recommended to include initial-scale=1 | Specifies a responsive viewport. Learn more in `Create Responsive AMP Pages`.|
